  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (result.success) {
        ...
        setTimeout(() => setMessageVisible(false), 3000); // Hide message after 6 seconds
      }
    } catch (error) {
    ...
    >
      <div className="text-center lg:text-left z-10">
        ...
        <div className="socials flex flex-row gap-2 justify-center lg:justify-start">
          <Connectlink
            href="https://github.com/chetali-1004"
            path="/images/github.png"
          />
          <Connectlink
            href="https://www.linkedin.com/in/chetali-goyal-020860227/"
